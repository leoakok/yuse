...
| MCP stdio server unauthenticated | **Deferred**: dev-only; do not expose in production |
| File upload content sniffing | **Deferred**: backend magic-byte validation |
| GraphQL query depth/complexity limits | **Deferred**: add gqlgen extensions |
