...
import type { PortfolioWithContent, SectionItem, SectionType } from "@/lib/types/portfolio";
import { levelsForSectionType } from "@/lib/cv/levels";
import { addPortfolioSectionItem, updatePortfolioSectionItem } from "@/lib/api/portfolio-api";
...
export function PortfolioSectionItemEditDialog({
  portfolioId,
  dialog,
  onOpenChange,
  onSaved,
  ...
  async function handleSave() {
    ...
    try {
      ...
      const updated =
        dialog.mode === "create"
          ? await addPortfolioSectionItem(portfolioId, dialog.sectionId, {
              headline: form.headline,
              body: form.body,
              metadata,
            })
          : await updatePortfolioSectionItem(
              portfolioId,
              dialog.sectionId,
              dialog.item.id,
              {
