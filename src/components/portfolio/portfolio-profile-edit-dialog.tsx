...
import type { ContactProfile, PortfolioWithContent } from "@/lib/types/portfolio";
...
interface PortfolioProfileEditDialogProps {
  portfolioId: string;
...
export function PortfolioProfileEditDialog({
  portfolioId,
  contactProfile,
  open,
  onOpenChange,
  onSaved,
}: PortfolioProfileEditDialogProps) {
  ...
  async function handleSave() {
    ...
    setIsSaving(true);
    try {
      const updated = await updatePortfolioContactProfile(portfolioId, {
