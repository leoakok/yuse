...
func (m *Memory) ListAutomationRuns(_ string, _, _ int) ([]*AutomationRunRecord, error) {
	return nil, nil
}
...
func (m *Memory) ListLinkedInApplications(_, _ int) ([]*LinkedInApplicationRecord, error) {
	return []*LinkedInApplicationRecord{}, nil
}
